...
<html>
    ...
    <body>
        ...
        <div class="details">
            <form action="uploadresult.php" method="post" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
                <h1><b>ADD RESULT</b></h1><br/><br/>

                <div class="input-group">
                    <input type="file" name="file" id="file" required accept=".xls,.xlsx">
                    <label for="dob">FILE</label>
                </div>
                <div class="input-group">
                    <input type="text" name="year" id="year" required>
                    <label for="year">YEAR AND MONTH</label>
                </div>
